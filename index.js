...
export default class Services {
    ...
    queryOrder(symbol, orderId, origClientOrderId, recvWindow) {
        ...
        if (typeof orderId === 'undefined' && typeof origClientOrderId === 'undefined') {
            throw 'Either orderId or origClientOrderId must be sent';
        }
    ...
    cancelOrder(args) {
        ...
        args.recvWindow = args.recvWindow ? args.recvWindow : '6000000';
        return this._methodCall(Methods.cancel_order, args);
    }
    ...
    keepaliveUserDataStream(args) {
        return this._methodCall(Methods.ka_user_data_stream);
    }
